...
|---|---|---|
| `4.0.19.2979-krzw.18` | a tagged release (immutable) | **production — pin to this** |
...
docker run -d --name sonarr \
  ...
  ghcr.io/krz-w/sonarr:4.0.19.2979-krzw.18
```
...
services:
  sonarr:
    image: ghcr.io/krz-w/sonarr:4.0.19.2979-krzw.18

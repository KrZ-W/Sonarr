...
|---|---|---|
| `4.0.19.2979-krzw.1` | a tagged release (immutable) | **production — pin to this** |
...
docker run -d --name sonarr \
  ...
  ghcr.io/krz-w/sonarr:4.0.19.2979-krzw.1
```
...
services:
  sonarr:
    image: ghcr.io/krz-w/sonarr:4.0.19.2979-krzw.1

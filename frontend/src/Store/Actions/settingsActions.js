...
import metadataOptions from './Settings/metadataOptions'; // krzw(imdb-title-provider)
...
export * from './Settings/metadataOptions'; // krzw(imdb-title-provider)
...
export const defaultState = {
  ...
  metadataOptions: metadataOptions.defaultState, // krzw(imdb-title-provider)
...
export const actionHandlers = handleThunks({
  ...
  ...metadataOptions.actionHandlers, // krzw(imdb-title-provider)
...
export const reducers = createHandleActions({
  ...
  ...metadata.reducers,
  ...metadataOptions.reducers, // krzw(imdb-title-provider)
  ...naming.reducers,

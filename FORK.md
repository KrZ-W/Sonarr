...
- **Current fork version:** `v4.0.19.2979+krzw.19`
...
```
git tag      v4.0.19.2979+krzw.19
docker image ghcr.io/krz-w/sonarr:4.0.19.2979-krzw.19
```
...
docker pull ghcr.io/krz-w/sonarr:4.0.19.2979-krzw.19
...
| [Sonarr#8453](https://github.com/Sonarr/Sonarr/issues/8453) external audio language provider / AI-assisted tagging | not planned (2026) | [Audio Language Verification](docs/features/audio-language-verification.md), [Audio Track Retag](docs/features/audio-track-retag.md) | Implemented natively (Whisper detection at import + tags written back to the file) |
